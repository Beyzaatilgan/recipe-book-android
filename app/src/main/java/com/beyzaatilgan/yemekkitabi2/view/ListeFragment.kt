...
import com.beyzaatilgan.yemekkitabi2.adapter.TarifAdapter
import com.beyzaatilgan.yemekkitabi2.databinding.FragmentListeBinding
...
class ListeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tarifRcyclerView.layoutManager = LinearLayoutManager(requireContext())
        verileriAl()
    }
    ...
    private fun handleResponse(tarifler: List<Tarif>){
        ...
        binding.tarifRcyclerView.adapter = adapter
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        _binding = null
        mDisposable.clear() //Destroy olurken içerisinde tuttuklarını temizler.
